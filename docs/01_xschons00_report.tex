...
\begin{itemize}
	\item Implementoval základné obrazovky a navigáciu: domovskú stránku (\texttt{src/scripts/MainPage.gd}) a globálne menu (\texttt{src/scripts/components/Menu.gd}), ktoré sa pripája na \texttt{Globals.data\_manager} a po signáli \texttt{refresh\_menu\_signal} obnovuje avatara, pozadie, mince a ELO priamo v UI.
